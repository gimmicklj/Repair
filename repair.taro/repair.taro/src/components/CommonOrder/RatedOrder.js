...
import {RepairOrderGetRatedOrderPagedList} from "../../api";
import styled from "./index.module.scss"
import {AtButton} from "taro-ui";
import Taro from "@tarojs/taro";
import {isImage} from "../../utils"

export const RatedOrder = (props) => {
  ...
  function getList () {
    RepairOrderGetRatedOrderPagedList().then(res => {
      setList(() => res.data)
    })
  }
  ...
  const edit = (item) => {
    console.log(item)
    Taro.navigateTo({
      url: "/AuditOrder/pages/AuditOrderIview/AuditOrderIview?id="+item.id
    })
  }
